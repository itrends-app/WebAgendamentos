...
$mensagem = "<h3>Olá, você confirmou a sua presença no encontro de monitoria. <br>Categoria: " . utf8_encode($_SESSION['nome_categoria']) . ""
        ...
        . "<a href='http://neadteste.fcrs.edu.br/uniagendamentos/aluno/php/pega_dados_via_email.php?id=$lastid&email=$email&edt=$monitor_id'>Clique aqui para editar o agendamento</a></h3>";
